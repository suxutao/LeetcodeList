...
<ul> 
 <li> <p>如果当前数字为偶数，则将其除以 <code>2</code> 。</p> </li> 
 <li> <p>如果当前数字为奇数，则将其加上 <code>1</code> 。</p> </li> 
</ul>
...
<div><div>Related Topics</div><div><li>位运算</li><li>字符串</li><li>模拟</li></div></div><br><div><li>👍 67</li><li>👎 0</li></div>